...
func initFlags(command *cobra.Command) {
	...
	command.Flags().StringVarP(&opts.DefaultDataSource, "default-datasource", "", "", "The default `datasource name` to use, wraps all templates with {{ with datasource 'default' }} ")
